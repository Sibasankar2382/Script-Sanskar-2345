...
| Files | Description |
|-------| ------------|
| **NIFTY50_Stocks_Data_ipynb** | This folder includes raw datasets, as well as the merged data used for model creation and analysis Also this folder houses all files related to Google Sheets integration, including the model and datasets. |
